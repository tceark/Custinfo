   CBL NUMPROC(MIG),FLAG(I,W),RENT
      ...
      * Enterprise COBOL zUnit Test Case Sample EPSMPMT.cbl            *
      *                                                                *
      * @since   14.1.5.0                                              *
      * @version 14.1.5.0                                              *
      ******************************************************************
      ...
      *
       A000-MAINLINE.
           ...
           DISPLAY 'VAL IND:' VALIDATION-INDICATOR.
      ...
      *
       ...
       A200-CALULATE-MONTH-PAYMENT.
           DISPLAY 'PRINCIPLE:' EPSPDATA-PRINCIPLE-DATA.
           DISPLAY 'WS-CALC-INTEREST:' WS-CALC-INTEREST.
           DISPLAY 'WS-NUMBER-OF-MONTHS:' WS-NUMBER-OF-MONTHS.
           ...
           .
           DISPLAY 'PAYMENT:' EPSPDATA-RETURN-MONTH-PAYMENT.
