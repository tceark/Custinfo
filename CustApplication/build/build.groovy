...
/**
 * This is the main build script for the Customer Application.
 *
 ...
 *
 * All command line options can be set in the CustApplication/build/build.properties file
...
println("** Build properties list end")
...
// incremental build or full build
	...
	if (lastBuildHash == null) {
		...
		GroovyObject script = loadScript(new File("${properties.sourceDir}/CustApplication/build/impacts.groovy      "))
