...
/**
* This script builds a DB2 application package for SQL programs in the CustApplication sample.  It is
* called by the CobolCompile.groovy script.  It requires that the properties in CustApplication/build/bind.properties
...
if (!clist.exists()) {
   clist << """PROC 5 SUBSYS MEMBER LIB OWNER QUAL
   DSN SYSTEM(&SUBSYS)
   BIND PACKAGE(&MEMBER)    +
        MEMBER(&MEMBER)     +
        RELEASE(DEALLOCATE) +
